...
} from './core/components/layout-components/';
import { FullLayoutComponent, SimpleLayoutWithHeightComponent } from './core/components/containers';
import { ReplaceDirective } from './core/directives';
import {
  AsideToggleDirective,
  NAV_DROPDOWN_DIRECTIVES,
  SIDEBAR_TOGGLE_DIRECTIVES
} from './core/components/layout-components/app-sidebar/directives';
...
const APP_CONTAINERS = [FullLayoutComponent, SimpleLayoutWithHeightComponent];
